...
// Extraer corners del JSON histórico
...
// Extraer tarjetas del JSON histórico
...
function extractFeatures(match: HistoricalMatch, allMatches: HistoricalMatch[]): MatchFeatures | null {
  try {
