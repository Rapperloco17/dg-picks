...
export default function LocalDataAdminContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-zinc-100">Datos Locales</h1>
      ...
      <div className="p-4 rounded-lg border border-amber-500/30 bg-amber-500/10">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-amber-500 font-medium">Importante: Temporada Actual</h3>
            ...
            <p className="text-sm text-zinc-500 mt-2">
              ...
              <Link href="/admin/sync-data" className="text-amber-500 hover:underline ml-1">
          ...
          <Card className="glass border-0">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-zinc-100">{formatNumber(summary.totalMatches)}</p>
                  <p className="text-sm text-zinc-500">Partidos</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass border-0">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-zinc-100">{summary.totalLeagues}</p>
                  <p className="text-sm text-zinc-500">Ligas</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass border-0">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-zinc-100">{formatNumber(summary.totalTeams)}</p>
          ...
          <Card className="glass border-0">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-zinc-100">{summary.seasons.length}</p>
      ...
      <Card className="glass border-0">
        <CardHeader>
          <CardTitle className="flex items-center justify-between text-zinc-100">
            ...
            <Badge variant="outline" className="border-zinc-700">{AVAILABLE_LOCAL_LEAGUES.length} ligas</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-wrap gap-2">
            {AVAILABLE_LOCAL_LEAGUES.map(leagueId => (
              <Badge 
                key={leagueId} 
                variant="secondary"
                className="text-xs bg-[#1a1a1a] border-[#262626]"
              >
                {leagueId}
              </Badge>
            ))}
      ...
      <Card className="glass border-0">
        <CardHeader>
          <CardTitle className="text-zinc-100">Cómo Funciona</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div className="space-y-2">
            <p className="font-medium text-zinc-100">1. Datos Locales Primero</p>
            <p className="text-zinc-500">
          ...
          <div className="space-y-2">
            <p className="font-medium text-zinc-100">2. API como Respaldo</p>
            <p className="text-zinc-500">
          ...
          <div className="space-y-2">
            <p className="font-medium text-zinc-100">3. Siempre Actualizado</p>
            <p className="text-zinc-500">
